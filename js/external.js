...
console.log('fave: ' +typeof faveColor)
console.log(faveColor)
let isNumb = faveColor >= 0;
console.log("isNumb: " +isNumb)
while(isNumb === true){
    prompt('Whats your fave color?')
}
if (faveColor && isNumb !== true ) {
    alert(`My fave color is ${faveColor} and your fave color is ${faveColor}, what are the odds!`)
    // } else if(faveColor <= 0 && faveColor >= 0) {
}
// else{
//     prompt('Whats your fave color?')
// }
